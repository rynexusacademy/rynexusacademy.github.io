  ...
  if ($(".contact-form-validated").length) {
    $(".contact-form-validated").validate({
      ...
      submitHandler: function (form) {
        // Display loader while sending
        $(form).find('button[type="submit"]').prop("disabled", true).text("Sending..."); // Disable button to prevent multiple submissions
        $(form).parent().find(".result").html("<p>Sending your message...</p>"); // Show "sending" message
        ...
        $.ajax({
          ...
          success: function (response) {
            ...
            $(form).parent().find(".result").html("<p>Your message has been sent successfully!</p>");
            $(form).find('input[type="text"], input[type="email"], textarea').val(""); // Clear form fields
            $(form).find('button[type="submit"]').prop("disabled", false).text("Send a Message"); // Re-enable the submit button
          },
          error: function () {
            // Show error message if submission fails
            $(form).parent().find(".result").html("<p>There was an error sending your message. Please try again later.</p>");
            $(form).find('button[type="submit"]').prop("disabled", false).text("Send a Message");
          }
        });
